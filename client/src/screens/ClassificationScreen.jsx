...
export default function ClassificationScreen() {
    ...
    const [detected, setDetected] = useState(null) // { category, confidence }
    ...
    function onProceed() {
        // ensure category persisted in context (already set), then navigate
        navigate('/benefits')
    }
